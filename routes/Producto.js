...
app.get('/obtener_inventario_entrada_admin/:year/:month',productoController.obtener_inventario_entrada_admin)
app.get('/obtener_inventario_salida_admin/:year/:month',productoController.obtener_inventario_salida_admin)
module.exports = app;
