...
//el tipo nos referimos en el modelo de pago q tiene tipos como "matricula" o "producto" si quieres fijate en tu database
...
const kpi_metodos_pago = async function (req, res) {
  if (req.user) {
    ...
    let pagos_tarjera = await Pago.find({
      createdAt: {
        $gte: new Date(inicio + "T00:00:00"),
        $lt: new Date(hasta),
      },
...
module.exports = { kpi_pagos_mensuales, kpi_pagos_tipo,kpi_metodos_pago,kpi_curso_ganancia,kpi_prospectos_mensuales,kpi_prospectos_genero};
